...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openAIVideoJobRepository := repository.NewOpenAIVideoJobRepository(db)
	openAIGatewayService := service.NewOpenAIGatewayService(accountRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, httpUpstream, deferredService, openAITokenProvider, grokTokenProvider, modelPricingResolver, channelService, balanceNotifyService, settingService, serviceUserPlatformQuotaRepository, openAIVideoJobRepository)
	...
	accountTestService := service.ProvideAccountTestService(accountRepository, geminiTokenProvider, claudeTokenProvider, grokTokenProvider, antigravityGatewayService, httpUpstream, configConfig, tlsFingerprintProfileService, openAIGatewayService, platformService)
	...
	platformHandler := admin.NewPlatformHandler(platformService)
	complianceHandler := admin.NewComplianceHandler(settingService)
	membershipRepository := repository.NewMembershipRepository(db)
	membershipService := service.ProvideMembershipService(membershipRepository, userRepository, groupRepository, userGroupRateRepository, apiKeyService, authService, adminService)
	membershipHandler := admin.NewMembershipHandler(membershipService)
	auditLogRepository := repository.NewAuditLogRepository(db)
	auditLogService := service.ProvideAuditLogService(auditLogRepository, settingService)
	auditLogHandler := admin.NewAuditLogHandler(auditLogService, totpService)
	upstreamBillingProbeService := service.ProvideUpstreamBillingProbeService(accountRepository, accountTestService, settingService, leaderLockCache, db)
	ollamaCloudUsageService := service.ProvideOllamaCloudUsageService(accountRepository, httpUpstream, settingService, secretEncryptor, configConfig, leaderLockCache, db)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, platformHandler, complianceHandler, membershipHandler, auditLogHandler, upstreamBillingProbeService, ollamaCloudUsageService)
	...
	videoCollectorHandler := handler.NewVideoCollectorHandler(membershipService)
	...
	workbenchControlTokenService := service.NewWorkbenchControlTokenService(authService, userService, workbenchControlGrantStore)
	workbenchSSOService := service.NewWorkbenchSSOService(configConfig, settingService, workbenchSSOTicketStore, userService, membershipService, announcementService, workbenchControlTokenService)
	...
	membershipExpiryService := service.ProvideMembershipExpiryService(membershipService)
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, handlerMembershipHandler, videoCollectorHandler, workbenchSSOHandler, platformHandler, asyncImageHandler, batchImageHandler, idempotencyCoordinator, idempotencyCleanupService, membershipExpiryService)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, auditLogMiddleware, stepUpAuthMiddleware, apiKeyService, subscriptionService, opsService, settingService, platformService, compositeRouteResolver, redisClient)

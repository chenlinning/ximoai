...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	workbenchSSOService := service.NewWorkbenchSSOService(configConfig, settingService, workbenchSSOTicketStore, userService, membershipService, announcementService)
	workbenchSSOHandler := handler.NewWorkbenchSSOHandler(workbenchSSOService)
	workbenchModelAccessService := service.NewWorkbenchModelAccessService(configConfig, userService, membershipService)
	workbenchModelAccessHandler := handler.NewWorkbenchModelAccessHandler(workbenchModelAccessService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, handlerMembershipHandler, workbenchSSOHandler, workbenchModelAccessHandler, platformHandler, asyncImageHandler, batchImageHandler, idempotencyCoordinator, idempotencyCleanupService, membershipExpiryService)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, auditLogMiddleware, stepUpAuthMiddleware, apiKeyService, subscriptionService, opsService, settingService, platformService, redisClient)

...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountTestService := service.ProvideAccountTestService(accountRepository, geminiTokenProvider, claudeTokenProvider, grokTokenProvider, antigravityGatewayService, httpUpstream, configConfig, tlsFingerprintProfileService, openAIGatewayService, platformService, settingService)
	...
	desktopSessionService := service.NewDesktopSessionService(authService, userService, workbenchSSOService, desktopSessionStore)
	desktopSSOBrokerService := service.NewDesktopSSOBrokerService(authService, desktopSessionService, workbenchSSOService)
	workbenchSSOHandler := handler.NewWorkbenchSSOHandler(workbenchSSOService, desktopSSOBrokerService)
	desktopSessionHandler := handler.NewDesktopSessionHandler(desktopSessionService, desktopSSOBrokerService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, channelMonitorV2Handler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, passkeyHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, handlerMembershipHandler, workbenchSSOHandler, desktopSessionHandler, platformHandler, modelPlazaHandler, asyncImageHandler, batchImageHandler, idempotencyCoordinator, idempotencyCleanupService, membershipExpiryService)

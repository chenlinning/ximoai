...
func TestAccountHandlerSyncUpstreamModelsPreview_CustomNativeProtocols(t *testing.T) {
	tests := []struct {
		name       string
		slug       string
		protocol   string
	...
	}{
		{
			...
			response:   `{"platform":"acme-gemini","type":"apikey","protocol":"gemini","credentials":{"base_url":"https://gemini.example.com","api_key":"gemini-key"}}`,
		...
		},
		{
			...
			response:   `{"platform":"acme-anthropic","type":"apikey","protocol":"gemini","credentials":{"base_url":"https://anthropic.example.com","api_key":"anthropic-key","platform_protocol":"gemini"},"extra":{"anthropic_apikey_auth_scheme":"authorization_bearer"}}`,

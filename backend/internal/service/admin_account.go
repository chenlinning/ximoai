...
func (s *adminServiceImpl) CreateAccount(ctx context.Context, input *CreateAccountInput) (*Account, error) {
	...
	accountExtra, err := normalizeOpenAILongContextBillingExtra(platformSlug, input.Extra)
	if err != nil {
		return nil, err
	}
	...
	account := &Account{
		...
		Concurrency: normalizeAccountConcurrency(platformSlug, accountType, input.Concurrency),

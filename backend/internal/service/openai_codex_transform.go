...
const (
	...
	codexImageGenerationBridgeText   = codexImageGenerationBridgeMarker + "\nWhen the request includes the OpenAI Responses `image_generation` tool, use the upstream tool result for raster image generation or editing and return it through the normal response flow.\n</sub2api-codex-image-generation>"
	codexSparkImageUnsupportedMarker = "<sub2api-codex-spark-image-unsupported>"
	codexSparkImageUnsupportedText   = codexSparkImageUnsupportedMarker + "\nThe current model is gpt-5.3-codex-spark and is intended for text-only Codex work. If the user asks for image generation, image editing, or image input, ask them to use a multimodal Codex model such as gpt-5.3-codex or gpt-5.4.\n</sub2api-codex-spark-image-unsupported>"
)

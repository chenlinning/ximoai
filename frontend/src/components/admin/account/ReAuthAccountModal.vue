<template>
  ...
  >
    <div v-if="account" class="space-y-4">
      <!-- Account Info -->
      <div
        class="rounded-lg border border-accent-200 bg-accent-50 p-4 dark:border-dark-600 dark:bg-dark-700"
      >
        <div class="flex items-center gap-3">
          ...
          <div>
            <span class="block font-semibold text-accent-900 dark:text-white">{{
              account.name
            }}</span>
      ...
      <div v-if="isGemini" class="rounded-lg border border-accent-200 bg-accent-50 p-4 dark:border-dark-600 dark:bg-dark-700">
        <div class="mb-2 text-sm font-medium text-accent-700 dark:text-accent-300">

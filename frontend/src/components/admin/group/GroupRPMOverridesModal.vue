  ...
  <BaseDialog :show="show" :title="t('admin.groups.rpmOverridesTitle')" width="wide" @close="handleClose">
    <div v-if="group" class="space-y-4">
      ...
      <div class="rounded-lg border border-accent-200 p-3 dark:border-dark-600">
        ...
        <div v-if="localEntries.length > 0" class="mt-3 flex items-center justify-end border-t border-accent-100 pt-3 dark:border-dark-600">
          <button
            type="button"
            :disabled="clearing"
              ...
              <table class="w-full text-sm">
                <thead class="sticky top-0 z-[1]">
                  <tr class="border-b border-accent-200 bg-accent-50 dark:border-dark-600 dark:bg-dark-700">
                    ...
                    <th class="px-3 py-2 text-left text-xs font-medium text-accent-500 dark:text-accent-400" :title="t('admin.groups.columns.rpmOverrideHint')">{{ t('admin.groups.columns.rpmOverride') }}</th>

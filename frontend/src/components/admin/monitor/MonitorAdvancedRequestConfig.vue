  ...
  <div class="space-y-4">
    ...
    <div>
      ...
      <div class="space-y-1.5">
        ...
        >
          ...
          <button
            type="button"
            class="flex-none rounded p-1 text-accent-400 hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-500/10 dark:hover:text-red-400"
        ...
        <button
          type="button"
          class="inline-flex items-center gap-1 rounded border border-dashed border-accent-300 px-2 py-1 text-xs text-accent-500 hover:border-primary-400 hover:text-primary-600 dark:border-dark-600 dark:text-accent-400 dark:hover:border-primary-500 dark:hover:text-primary-400"
          @click="addRow"
        >
      ...
      <p v-else class="mt-1 text-xs text-accent-400">
    ...
    <div v-if="bodyOverrideMode !== 'off'">
      <div class="mb-1 flex items-center justify-between">
        ...
        <button
          type="button"
          class="text-xs text-primary-600 hover:underline disabled:cursor-not-allowed disabled:text-accent-400 disabled:no-underline dark:text-primary-400"
...
function bodyModeButtonClass(mode: BodyOverrideMode): string {
  ...
  return 'border-accent-200 bg-white text-accent-600 hover:border-primary-300 dark:border-dark-700 dark:bg-dark-800 dark:text-accent-400'
}

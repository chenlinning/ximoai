<template>
  <section class="py-3 md:py-4">
    <div class="flex items-center justify-end gap-3 flex-wrap">
      <div
        role="tablist"
        class="inline-flex p-0.5 rounded-xl bg-accent-100 dark:bg-dark-800 border border-accent-200/60 dark:border-dark-700/60 text-xs"
      >
        <button
          ...
          :class="window === opt.value
            ? 'bg-white dark:bg-dark-700 shadow-sm text-accent-900 dark:text-white font-semibold'
      ...
      <button
        type="button"
        class="h-8 w-8 rounded-lg flex items-center justify-center text-accent-500 hover:text-accent-700 hover:bg-accent-100 dark:text-accent-400 dark:hover:text-accent-200 dark:hover:bg-dark-700 transition-colors disabled:opacity-50"
        :disabled="loading"

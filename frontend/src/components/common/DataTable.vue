...
.table-wrapper::-webkit-scrollbar-track {
  background-color: rgb(var(--color-shadow) / 0.03) !important;
  border-radius: 6px !important;
  margin: 0 4px !important;
}
.dark .table-wrapper::-webkit-scrollbar-track {
  background-color: rgb(var(--color-highlight) / 0.05) !important;
}

/* 常驻、不透明的滑块，无视鼠标是否 hover 都在那！ */
.table-wrapper::-webkit-scrollbar-thumb {
  background-color: rgb(var(--color-gray-500) / 0.75) !important;
  border-radius: 6px !important;
...
.table-wrapper::-webkit-scrollbar-thumb:hover {
  background-color: rgb(var(--color-gray-600) / 0.9) !important;
}

.dark .table-wrapper::-webkit-scrollbar-thumb {
  background-color: rgb(var(--color-gray-400) / 0.75) !important;
}
.dark .table-wrapper::-webkit-scrollbar-thumb:hover {
  background-color: rgb(var(--color-gray-300) / 0.9) !important;
}
...
@supports (-moz-appearance:none) {
  .table-wrapper {
    ...
    scrollbar-color: rgb(var(--color-gray-400) / 0.5) rgb(var(--color-shadow) / 0.03) !important;
  }
  .dark .table-wrapper {
    scrollbar-color: rgb(var(--color-gray-600) / 0.5) rgb(var(--color-highlight) / 0.05) !important;
  }
}
</style>

      ...
      <div v-if="isOpen" class="date-picker-dropdown">
        ...
        <div class="date-picker-custom">
          ...
          <div class="date-picker-separator">
            <Icon name="arrowRight" size="sm" class="text-accent-400" />
          </div>
          <div class="date-picker-field">
...
.date-picker-icon {
  @apply text-accent-400 dark:text-dark-400;
}
...
.date-picker-preset {
  ...
  @apply hover:bg-accent-100 dark:hover:bg-dark-700;
...
.date-picker-divider {
  @apply border-t border-accent-100 dark:border-dark-700;
}
...
.date-picker-label {
  @apply mb-1 block text-xs font-medium text-accent-500 dark:text-accent-400;
}

.date-picker-input {
  @apply w-full rounded-md px-2 py-1.5 text-sm;
  @apply bg-accent-50 dark:bg-dark-700;
  @apply border border-accent-200 dark:border-dark-600;

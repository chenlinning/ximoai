...
<template>
  <div v-if="allEndpoints.length > 0" class="flex flex-wrap gap-2">
    <div
      ...
      :key="index"
      class="flex items-center gap-1.5 rounded-lg border border-accent-200 bg-white px-2.5 py-1.5 text-xs transition-colors hover:border-primary-200 dark:border-dark-600 dark:bg-dark-800 dark:hover:border-primary-700"
    >
      <span class="font-medium text-accent-600 dark:text-accent-300">{{ item.name }}</span>
      <span
        v-if="item.isDefault"
      ...
      <div class="group/endpoint relative flex items-center gap-1.5">
        ...
        <button
          ...
          :class="copiedEndpoint === item.endpoint
            ...
            : 'text-accent-400 hover:text-primary-500 dark:text-accent-500 dark:hover:text-primary-400'"
        ...
        <a
          ...
          class="rounded p-0.5 text-accent-400 transition-colors hover:text-amber-500 dark:text-accent-500 dark:hover:text-amber-400"

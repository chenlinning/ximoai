  ...
  >
    ...
    >
      ...
      <div v-if="account.type === 'apikey'" class="space-y-4">
        ...
        <div v-if="account.platform !== 'antigravity'" class="border-t border-accent-200 pt-4 dark:border-dark-600">
      ...
      >
        ...
        <div class="rounded-lg bg-accent-50 px-3 py-2 text-xs text-accent-600 dark:bg-dark-700 dark:text-accent-300">
          <span class="font-medium">{{ t(openAICompactStatusKey) }}</span>
          <span
            v-if="account?.extra?.openai_compact_checked_at"
            class="ml-2 text-accent-500 dark:text-accent-400"
          >
        ...
        <div v-if="account?.platform === 'antigravity'" class="flex items-center gap-2">
          <label class="flex cursor-not-allowed items-center gap-2 opacity-60">
            <input
              ...
              disabled
              class="h-4 w-4 cursor-not-allowed rounded border-accent-300 text-primary-500 focus:ring-primary-500 dark:border-dark-500"
            />

<template>
  ...
  >
        ...
        <div class="flex items-center">
          <div
            :class="[
              ...
              step >= 1 ? 'bg-primary-500 text-white' : 'bg-accent-200 text-accent-500 dark:bg-dark-600'
            ]"
          >
            1
          </div>
          <span class="ml-2 text-sm font-medium text-accent-700 dark:text-accent-300">{{
            t('admin.accounts.oauth.authMethod')
          }}</span>
        </div>
        <div class="h-0.5 w-8 bg-accent-300 dark:bg-dark-600" />
        <div class="flex items-center">
          <div
            :class="[
              'flex h-8 w-8 items-center justify-center rounded-full text-sm font-semibold',
              step >= 2 ? 'bg-primary-500 text-white' : 'bg-accent-200 text-accent-500 dark:bg-dark-600'
            ]"
          >
            2
          </div>
    ...
    >
      ...
      <div>
        ...
        <div class="mt-2 flex rounded-lg bg-accent-100 p-1 dark:bg-dark-700" data-tour="account-form-platform">
          <button
            type="button"
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-accent-200 hover:border-orange-300 dark:border-dark-600 dark:hover:border-orange-700'
            ]"
          >
            <div
              :class="[
                ...
                accountCategory === 'oauth-based'
                  ...
                  : 'bg-accent-100 text-accent-500 dark:bg-dark-600 dark:text-accent-400'
              ]"
            >
              <Icon name="sparkles" size="sm" />
            </div>
            <div>
              <span class="block text-sm font-medium text-accent-900 dark:text-white">{{
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'apikey'
                ...
                : 'border-accent-200 hover:border-purple-300 dark:border-dark-600 dark:hover:border-purple-700'
            ]"
          >
            <div
              :class="[
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'bedrock'
                ...
                : 'border-accent-200 hover:border-amber-300 dark:border-dark-600 dark:hover:border-amber-700'
            ]"
          >
            <div
              :class="[
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'service_account'
                ...
                : 'border-accent-200 hover:border-sky-300 dark:border-dark-600 dark:hover:border-sky-700'
            ]"
          >
            <div
              :class="[
            ...
            <div>
              <span class="block text-sm font-medium text-accent-900 dark:text-white">Vertex</span>
              <span class="text-xs text-accent-500 dark:text-accent-400">Service Account</span>
            </div>
          </button>
      ...
      <div v-if="form.platform === 'openai'">
        ...
        <div class="mt-2 grid grid-cols-2 gap-3" data-tour="account-form-type">
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-accent-200 hover:border-green-300 dark:border-dark-600 dark:hover:border-green-700'
            ]"
          >
            <div
              :class="[
            ...
            <div>
              <span class="block text-sm font-medium text-accent-900 dark:text-white">OAuth</span>
              <span class="text-xs text-accent-500 dark:text-accent-400">{{ t('admin.accounts.types.chatgptOauth') }}</span>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-accent-900 dark:text-white">API Key</span>
              <span class="text-xs text-accent-500 dark:text-accent-400">{{ t('admin.accounts.types.responsesApi') }}</span>
            </div>
          </button>
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-accent-200 hover:border-blue-300 dark:border-dark-600 dark:hover:border-blue-700'
            ]"
          >
            <div
              :class="[
        ...
        <div v-if="accountCategory === 'oauth-based'" class="mt-4">
          ...
          <div class="mt-2 grid grid-cols-2 gap-3">
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <div class="mt-1 text-xs text-accent-500 dark:text-accent-400">
                  需要激活 GCP 项目并绑定信用卡
                  <a
          ...
          <div class="mt-3">
            <button
              ...
              class="flex items-center gap-2 text-sm text-accent-600 hover:text-accent-900 dark:text-accent-400 dark:hover:text-accent-200"
            >
              <svg
      ...
      <div v-if="form.platform === 'antigravity'">
        ...
        <div class="mt-2 grid grid-cols-2 gap-3">
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-accent-900 dark:text-white">OAuth</span>
              <span class="text-xs text-accent-500 dark:text-accent-400">{{ t('admin.accounts.types.antigravityOauth') }}</span>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-accent-900 dark:text-white">API Key</span>
              <span class="text-xs text-accent-500 dark:text-accent-400">{{ t('admin.accounts.types.antigravityApikey') }}</span>
            </div>
          </button>
        </div>
      </div>
        ...
        <div>
          ...
          <div
            :class="[
              ...
              vertexServiceAccountDragActive
                ...
                : 'border-accent-300 bg-accent-50 hover:border-sky-400 hover:bg-sky-50/60 dark:border-dark-500 dark:bg-dark-700/40 dark:hover:border-sky-600 dark:hover:bg-sky-900/10'
            ]"
          ...
          >
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div class="min-w-0">
                <div class="flex items-center gap-2 text-sm font-medium text-accent-900 dark:text-white">
      ...
      <div v-if="form.platform === 'antigravity'" class="border-t border-accent-200 pt-4 dark:border-dark-600">
        ...
        <div>
          ...
          <div v-if="antigravityModelMappings.length > 0" class="mb-3 space-y-2">
            ...
            >
              <div class="flex items-center gap-2">
                ...
                />
                <svg class="h-4 w-4 flex-shrink-0 text-accent-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <button
            ...
            class="mb-3 w-full rounded-lg border-2 border-dashed border-accent-300 px-4 py-2 text-accent-600 transition-colors hover:border-accent-400 hover:text-accent-700 dark:border-dark-500 dark:text-accent-400 dark:hover:border-dark-400 dark:hover:text-accent-300"
          >
      ...
      <div v-if="form.platform === 'anthropic' && isOAuthFlow">
        ...
        <div class="mt-2 flex gap-4">
          <label class="flex cursor-pointer items-center">
            ...
            />
            <span class="text-sm text-accent-700 dark:text-accent-300">{{ t('admin.accounts.types.oauth') }}</span>
          </label>
          <label class="flex cursor-pointer items-center">
            <input
              v-model="addMethod"
      ...
      <div v-if="form.type === 'apikey' && form.platform !== 'antigravity'" class="space-y-4">
        ...
        <div class="border-t border-accent-200 pt-4 dark:border-dark-600">
          <label class="input-label">{{ t('admin.accounts.modelRestriction') }}</label>
          ...
          <template v-else>
              ...
              <button
                ...
                :class="[
                  ...
                  modelRestrictionMode === 'whitelist'
                    ...
                    : 'bg-accent-100 text-accent-600 hover:bg-accent-200 dark:bg-dark-600 dark:text-accent-400 dark:hover:bg-dark-500'
                ]"
              >
                <svg
            ...
            <div v-if="modelMappings.length > 0" class="mb-3 space-y-2">
              ...
              >
                ...
                />
                <svg
                  class="h-4 w-4 flex-shrink-0 text-accent-400"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
          ...
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                ...
                poolModeEnabled ? 'bg-primary-600' : 'bg-accent-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
        ...
        <div class="border-t border-accent-200 pt-4 dark:border-dark-600">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                customErrorCodesEnabled ? 'bg-primary-600' : 'bg-accent-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="customErrorCodesEnabled" class="space-y-3">
            ...
            <div class="flex flex-wrap gap-1.5">
              ...
              <span v-if="selectedErrorCodes.length === 0" class="text-xs text-accent-400">
          ...
          <div class="mt-2 flex gap-4">
            <label class="flex cursor-pointer items-center">
              <input
                ...
                class="mr-2 text-primary-600 focus:ring-primary-500"
              />
              <span class="text-sm text-accent-700 dark:text-accent-300">{{ t('admin.accounts.bedrockAuthModeSigv4') }}</span>
            </label>
            <label class="flex cursor-pointer items-center">
              <input
                v-model="bedrockAuthMode"
                ...
                class="mr-2 text-primary-600 focus:ring-primary-500"
              />
              <span class="text-sm text-accent-700 dark:text-accent-300">{{ t('admin.accounts.bedrockAuthModeApikey') }}</span>
            </label>
          </div>
        </div>
        ...
        <div>
          <label class="flex items-center gap-2 cursor-pointer">
            <input
              ...
              type="checkbox"
              class="rounded border-accent-300 text-primary-600 focus:ring-primary-500 dark:border-dark-500"
            />
            <span class="text-sm text-accent-700 dark:text-accent-300">{{ t('admin.accounts.bedrockForceGlobal') }}</span>
          </label>
      ...
      <div
        ...
        class="border-t border-accent-200 pt-4 dark:border-dark-600 space-y-4"
      >
        <div class="mb-3">
      ...
      <div
        ...
        class="border-t border-accent-200 pt-4 dark:border-dark-600"
      >
        <label class="input-label">{{ t('admin.accounts.modelRestriction') }}</label>
      ...
      <div class="border-t border-accent-200 pt-4 dark:border-dark-600 space-y-4">
        <div class="mb-3 flex items-center justify-between">
          <div>
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              tempUnschedEnabled ? 'bg-primary-600' : 'bg-accent-200 dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
        ...
        <div v-if="tempUnschedEnabled" class="space-y-3">
          ...
          <div class="flex flex-wrap gap-2">
            <button
              ...
              class="rounded-lg bg-accent-100 px-3 py-1.5 text-xs font-medium text-accent-600 transition-colors hover:bg-accent-200 dark:bg-dark-600 dark:text-accent-300 dark:hover:bg-dark-500"
            >
              + {{ preset.label }}
            </button>
          </div>
          ...
          <div v-if="tempUnschedRules.length > 0" class="space-y-3">
            <div
              ...
              class="rounded-lg border border-accent-200 p-3 dark:border-dark-600"
            >
              <div class="mb-2 flex items-center justify-between">
                <span class="text-xs font-medium text-accent-500 dark:text-accent-400">
                ...
                <div class="flex items-center gap-2">
                  <button
                    ...
                    class="rounded p-1 text-accent-400 transition-colors hover:text-accent-600 disabled:cursor-not-allowed disabled:opacity-40 dark:hover:text-accent-200"
                  >
          ...
          <button
            ...
            class="w-full rounded-lg border-2 border-dashed border-accent-300 px-4 py-2 text-sm text-accent-600 transition-colors hover:border-accent-400 hover:text-accent-700 dark:border-dark-500 dark:text-accent-400 dark:hover:border-dark-400 dark:hover:text-accent-300"
          >
            <svg
              class="mr-1 inline h-4 w-4"
              fill="none"
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              interceptWarmupRequests ? 'bg-primary-600' : 'bg-accent-200 dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
      ...
      >
        ...
        <!-- Window Cost Limit -->
        <div class="rounded-lg border border-accent-200 p-4 dark:border-dark-600">
          <div class="mb-3 flex items-center justify-between">
            <div>
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                windowCostEnabled ? 'bg-primary-600' : 'bg-accent-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="windowCostEnabled" class="grid grid-cols-2 gap-4">
            <div>
              ...
              <div class="relative">
                <span class="absolute left-3 top-1/2 -translate-y-1/2 text-accent-500 dark:text-accent-400">$</span>
                <input
        ...
        <div class="rounded-lg border border-accent-200 p-4 dark:border-dark-600">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                sessionLimitEnabled ? 'bg-primary-600' : 'bg-accent-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="sessionLimitEnabled" class="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div class="relative">
                ...
                />
                <span class="absolute right-3 top-1/2 -translate-y-1/2 text-accent-500 dark:text-accent-400">{{ t('common.minutes') }}</span>
              </div>
        ...
        <div class="rounded-lg border border-accent-200 p-4 dark:border-dark-600">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                rpmLimitEnabled ? 'bg-primary-600' : 'bg-accent-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
          ...
          <div class="mt-4">
            ...
            <p class="mt-1 text-xs text-accent-500 dark:text-accent-400 mb-2">
              ...
              <button type="button" v-for="opt in umqModeOptions" :key="opt.value"
                ...
                :class="[
                  ...
                  userMsgQueueMode === opt.value
                    ...
                    : 'bg-white dark:bg-dark-700 text-accent-700 dark:text-accent-300 border-accent-300 dark:border-dark-500 hover:bg-accent-50 dark:hover:bg-dark-600'
                ]">
                {{ opt.label }}
              </button>
            </div>
        ...
        <div class="rounded-lg border border-accent-200 p-4 dark:border-dark-600">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                tlsFingerprintEnabled ? 'bg-primary-600' : 'bg-accent-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-accent-200 p-4 dark:border-dark-600">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                sessionIdMaskingEnabled ? 'bg-primary-600' : 'bg-accent-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-accent-200 p-4 dark:border-dark-600">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                cacheTTLOverrideEnabled ? 'bg-primary-600' : 'bg-accent-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="cacheTTLOverrideEnabled" class="mt-3">
            ...
            <select
              ...
              class="mt-1 block w-full rounded-md border border-accent-300 bg-white px-3 py-2 text-sm shadow-sm focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500 dark:border-dark-500 dark:bg-dark-700 dark:text-white"
            >
        ...
        <div class="rounded-lg border border-accent-200 p-4 dark:border-dark-600">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                customBaseUrlEnabled ? 'bg-primary-600' : 'bg-accent-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              openaiPassthroughEnabled ? 'bg-primary-600' : 'bg-accent-200 dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              anthropicPassthroughEnabled ? 'bg-primary-600' : 'bg-accent-200 dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              codexCLIOnlyEnabled ? 'bg-primary-600' : 'bg-accent-200 dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
      ...
      <div>
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              autoPauseOnExpired ? 'bg-primary-600' : 'bg-accent-200 dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
        ...
        <div v-if="form.platform === 'antigravity'" class="flex items-center gap-2">
          <label class="flex cursor-pointer items-center gap-2">
            <input
              ...
              class="h-4 w-4 rounded border-accent-300 text-primary-500 focus:ring-primary-500 dark:border-dark-500"
            />
          ...
          <div class="group relative">
            <span
              class="inline-flex h-4 w-4 cursor-help items-center justify-center rounded-full bg-accent-200 text-xs text-accent-500 hover:bg-accent-300 dark:bg-dark-600 dark:text-accent-400 dark:hover:bg-dark-500"
            >
              ?
            </span>
            <!-- Tooltip（向下显示避免被弹窗裁剪） -->
            <div
              class="pointer-events-none absolute left-0 top-full z-[100] mt-1.5 w-72 rounded bg-accent-900 px-3 py-2 text-xs text-white opacity-0 transition-opacity group-hover:opacity-100 dark:bg-accent-700"
            >
              {{ t('admin.accounts.mixedSchedulingTooltip') }}
              <div
                class="absolute bottom-full left-3 border-4 border-transparent border-b-accent-900 dark:border-b-accent-700"
              ></div>
            </div>
          </div>
        </div>
  ...
  >
    <div class="space-y-6">
      <!-- Setup Guide Section -->
      <div>
        <h3 class="mb-3 text-sm font-semibold text-accent-900 dark:text-white">
          {{ t('admin.accounts.gemini.setupGuide.title') }}
        </h3>
        <div class="space-y-4">
          <div>
            <p class="mb-2 text-sm font-medium text-accent-700 dark:text-accent-300">
              {{ t('admin.accounts.gemini.setupGuide.checklistTitle') }}
            </p>
            <ul class="list-inside list-disc space-y-1 text-sm text-accent-600 dark:text-accent-400">
      ...
      <div class="border-t border-accent-200 pt-6 dark:border-dark-600">
        <h3 class="mb-3 text-sm font-semibold text-accent-900 dark:text-white">
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-xs">
            <thead class="bg-accent-50 dark:bg-dark-600">
              <tr>
                <th class="px-3 py-2 text-left font-medium text-accent-700 dark:text-accent-300">
            ...
            <tbody class="divide-y divide-accent-200 dark:divide-dark-600">
              <tr>
                <td class="px-3 py-2 text-accent-900 dark:text-white">
                  {{ t('admin.accounts.gemini.quotaPolicy.rows.googleOne.channel') }}
                </td>
                <td class="px-3 py-2 text-accent-600 dark:text-accent-400">Free</td>
                <td class="px-3 py-2 text-accent-600 dark:text-accent-400">
                  {{ t('admin.accounts.gemini.quotaPolicy.rows.googleOne.limitsFree') }}
                </td>
              </tr>
              <tr>
                <td class="px-3 py-2 text-accent-900 dark:text-white"></td>
                <td class="px-3 py-2 text-accent-600 dark:text-accent-400">Pro</td>
                <td class="px-3 py-2 text-accent-600 dark:text-accent-400">
              ...
              <tr>
                <td class="px-3 py-2 text-accent-900 dark:text-white"></td>
                <td class="px-3 py-2 text-accent-600 dark:text-accent-400">Ultra</td>
                <td class="px-3 py-2 text-accent-600 dark:text-accent-400">
              ...
              <tr>
                ...
                <td class="px-3 py-2 text-accent-600 dark:text-accent-400">Standard</td>
                <td class="px-3 py-2 text-accent-600 dark:text-accent-400">
              ...
              <tr>
                <td class="px-3 py-2 text-accent-900 dark:text-white"></td>
                <td class="px-3 py-2 text-accent-600 dark:text-accent-400">Enterprise</td>
                <td class="px-3 py-2 text-accent-600 dark:text-accent-400">
              ...
              <tr>
                <td class="px-3 py-2 text-accent-900 dark:text-white"></td>
                <td class="px-3 py-2 text-accent-600 dark:text-accent-400">Paid</td>
                <td class="px-3 py-2 text-accent-600 dark:text-accent-400">

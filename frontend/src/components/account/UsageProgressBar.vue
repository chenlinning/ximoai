<template>
  <div>
    ...
    <div class="flex items-center gap-1">
      ...
      <div class="h-1.5 w-8 shrink-0 overflow-hidden rounded-full bg-accent-200 dark:bg-accent-700">
        <div
      ...
      <!-- Reset time -->
      <span v-if="shouldShowResetTime" class="shrink-0 text-[10px] text-accent-400">
        {{ formatResetTime }}
      </span>
    </div>
  </div>

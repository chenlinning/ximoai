      ...
      <transition name="fade">
        ...
        >
          <div
            ...
            class="rounded-xl border border-accent-200 bg-accent-50 p-4 dark:border-dark-600 dark:bg-dark-800/60"
          >
            <div class="space-y-3">
              <div class="space-y-1">
              ...
              <label
                ...
                class="flex items-start gap-3 rounded-lg border border-accent-200 bg-white p-3 text-sm dark:border-dark-600 dark:bg-dark-900/50"
              >
                <input v-model="adoptDisplayName" type="checkbox" class="mt-1 h-4 w-4" />
                <span class="space-y-1">
                  <span class="block font-medium text-accent-900 dark:text-white">
                    {{ t('auth.oauthFlow.useDisplayName') }}
                  </span>
                  <span class="block text-accent-500 dark:text-dark-400">
              ...
              >
                ...
                <img
                  ...
                  class="h-10 w-10 rounded-full border border-accent-200 object-cover dark:border-dark-600"
                />
                <span class="space-y-1">
                  <span class="block font-medium text-accent-900 dark:text-white">
                    {{ t('auth.oauthFlow.useAvatar') }}
                  </span>
                  <span class="block break-all text-accent-500 dark:text-dark-400">
                    {{ suggestedAvatarUrl }}
                  </span>
                </span>
              </label>
          ...
          <template v-else-if="needsChooser">
            <div class="rounded-xl border border-accent-200 bg-accent-50 p-4 dark:border-dark-600 dark:bg-dark-800/60">
              <div class="space-y-4">
                <div class="space-y-1">
                  <p class="text-sm font-medium text-accent-900 dark:text-white">

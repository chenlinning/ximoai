...
<template>
  <section class="card p-4 md:p-5">
    <div class="mb-4 flex flex-wrap items-center justify-between gap-3">
      <h3 class="text-sm font-bold text-accent-900 dark:text-white">
    ...
    <div v-if="loading" class="py-8 text-center text-sm text-accent-500 dark:text-accent-400">
    ...
    <div v-else class="space-y-3">
        ...
        <div class="max-h-[420px] overflow-auto">
          <table class="min-w-full text-left text-xs md:text-sm">
            <thead class="sticky top-0 z-10 bg-white dark:bg-dark-800">
              <tr class="border-b border-accent-200 text-accent-500 dark:border-dark-700 dark:text-accent-400">
            ...
            <tbody>
              <tr
                v-for="row in items"
                :key="row.model"
                class="border-b border-accent-100 text-accent-700 last:border-b-0 dark:border-dark-800 dark:text-accent-200"
              >
      ...
      <div v-if="viewMode === 'topn'" class="mt-3 text-xs text-accent-500 dark:text-accent-400">

          ...
          <template #cell-title="{ value, row }">
            <div class="min-w-0">
              <div class="flex items-center gap-2">
                <span class="truncate font-medium text-accent-900 dark:text-white">{{ value }}</span>
              </div>
              <div class="mt-1 flex items-center gap-2 text-xs text-accent-500 dark:text-dark-400">
                <span>#{{ row.id }}</span>
                <span class="text-accent-300 dark:text-dark-700">·</span>

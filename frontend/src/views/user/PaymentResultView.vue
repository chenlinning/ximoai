      ...
      <template v-else>
        ...
        <div v-if="order" class="rounded-xl bg-white p-5 shadow-sm dark:bg-dark-800">
          <div class="space-y-3 text-sm">
            ...
            <div class="flex justify-between">
              <span class="text-accent-500 dark:text-accent-400">{{ t('payment.orders.baseAmount') }}</span>
              <span class="font-medium text-accent-900 dark:text-white">&#165;{{ baseAmount.toFixed(2) }}</span>
            </div>
            <div v-if="order.fee_rate > 0" class="flex justify-between">
              <span class="text-accent-500 dark:text-accent-400">{{ t('payment.orders.fee') }} ({{ order.fee_rate }}%)</span>
              <span class="font-medium text-accent-900 dark:text-white">&#165;{{ feeAmount.toFixed(2) }}</span>
            </div>
            <div class="flex justify-between">
        ...
        <div v-else-if="returnInfo" class="rounded-xl bg-white p-5 shadow-sm dark:bg-dark-800">
          <div class="space-y-3 text-sm">
            ...
            <div v-if="returnInfo.money" class="flex justify-between">
              <span class="text-accent-500 dark:text-accent-400">{{ t('payment.orders.payAmount') }}</span>
              <span class="font-medium text-accent-900 dark:text-white">&#165;{{ returnInfo.money }}</span>
            </div>

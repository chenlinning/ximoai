<template>
      ...
      <template #actions>
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              <p class="text-xs font-medium text-accent-500 dark:text-accent-400">
                {{ t('usage.totalRequests') }}
              </p>
              <p class="text-xl font-bold text-accent-900 dark:text-white">
        ...
        <div class="card p-4">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xs text-accent-500 dark:text-accent-400">{{ t('usage.perRequest') }}</p>
            </div>
          </div>
        </div>
        </div>
      ...
      <template #table>
        ...
        >
          ...
          <template #cell-endpoint="{ row }">
            <span class="text-sm text-accent-600 dark:text-accent-300 block max-w-[320px] whitespace-normal break-all">
          ...
          <template #cell-tokens="{ row }">
            ...
            <div v-else class="flex items-center gap-1.5">
              ...
              >
                <div
                  class="flex h-4 w-4 cursor-help items-center justify-center rounded-full bg-accent-100 transition-colors group-hover:bg-blue-100 dark:bg-accent-700 dark:group-hover:bg-blue-900/50"
                >
                  <Icon
                    name="infoCircle"
                    size="xs"
                    class="text-accent-400 group-hover:text-blue-500 dark:text-accent-500 dark:group-hover:text-blue-400"
                  />
                </div>
              </div>
            </div>
          ...
          <template #cell-user_agent="{ row }">
            <span v-if="row.user_agent" class="text-sm text-accent-600 dark:text-accent-400 block max-w-[320px] whitespace-normal break-all" :title="row.user_agent">{{ formatUserAgent(row.user_agent) }}</span>
            <span v-else class="text-sm text-accent-400 dark:text-accent-500">-</span>
          </template>
  ...
  <Teleport to="body">
    ...
    >
      <div
        class="whitespace-nowrap rounded-lg border border-accent-700 bg-accent-900 px-3 py-2.5 text-xs text-white shadow-xl dark:border-accent-600 dark:bg-accent-800"
      >
        ...
        <div
          class="absolute right-full top-1/2 h-0 w-0 -translate-y-1/2 border-b-[6px] border-r-[6px] border-t-[6px] border-b-transparent border-r-accent-900 border-t-transparent dark:border-r-accent-800"
        ></div>
      </div>
    </div>
  </Teleport>
      ...
      >
        <div class="space-y-1.5">
          ...
          <div class="mb-2 border-b border-accent-700 pb-1.5">
            ...
            <div v-else class="flex items-center justify-between gap-4">
              <span class="text-accent-400">{{ tooltipData.billing_mode === 'image' ? t('usage.imageUnitPrice') : t('usage.unitPrice') }}</span>
          ...
          <div class="flex items-center justify-between gap-6 border-t border-accent-700 pt-1.5">
            <span class="text-accent-400">{{ t('usage.billed') }}</span>

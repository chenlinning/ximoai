            ...
            <div>
              ...
              <div class="relative mt-1">
                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4">
                  <Icon name="gift" size="md" class="text-accent-400 dark:text-dark-500" />
                </div>
                <input
                  id="code"
                  v-model="redeemCode"
        ...
        <div class="p-6">
          ...
          <div v-else-if="history.length > 0" class="space-y-3">
            <div
              ...
              :key="item.id"
              class="flex items-center justify-between rounded-xl bg-accent-50 p-4 dark:bg-dark-800"
            >
              ...
              <div class="text-right">
                ...
                <p v-else class="text-xs text-accent-400 dark:text-dark-500">
                  {{ t('redeem.adminAdjustment') }}
                </p>
                <!-- Display notes for admin adjustments -->
                <p
                  v-if="item.notes"
                  class="mt-1 text-xs text-accent-500 dark:text-dark-400 italic max-w-[200px] truncate"
                  :title="item.notes"
                >
                  {{ item.notes }}
                </p>
          ...
          <div v-else class="empty-state py-8">
            <div
              class="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-accent-100 dark:bg-dark-800"
            >
              <Icon name="clock" size="xl" class="text-accent-400 dark:text-dark-500" />
            </div>

    ...
    <div class="mx-auto max-w-lg space-y-6 py-8" :class="isPopup ? 'px-4' : ''">
      ...
      <template v-else>
        ...
        <div v-if="order" class="card overflow-hidden">
          <div class="bg-gradient-to-br from-stripe-500 to-stripe-700 px-6 py-6 text-center">
            <p class="text-sm font-medium text-stripe-100">{{ t('payment.actualPay') }}</p>
        ...
        <template v-if="wechatQrUrl">
          <div class="card p-6">
            <div class="flex flex-col items-center space-y-4">
              ...
              <div class="relative rounded-lg border-2 border-wxpay-500 bg-wxpay-50 p-4 dark:border-wxpay-500/70 dark:bg-wxpay-950/20">
                <img :src="wechatQrUrl" alt="WeChat Pay QR" class="h-56 w-56 rounded" />
                <div class="pointer-events-none absolute inset-0 flex items-center justify-center">
                  <span class="rounded-full bg-wxpay-500 p-2 shadow ring-2 ring-white">
        ...
        <template v-else-if="redirecting">
          <div class="card p-6">
            <div class="flex flex-col items-center space-y-4 py-4">
              <div class="h-10 w-10 animate-spin rounded-full border-4 border-alipay-500 border-t-transparent"></div>

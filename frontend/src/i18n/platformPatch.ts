...
const zhPatch: MessageTree = {
  ...
  admin: {
    ...
    platforms: {
      ...
      protocol: '协议',
      capabilities: '能力',
      capabilitiesHint: '能力用于限定模型广场可选文档端点；请只勾选该平台上游实际支持的协议能力。',
      capability: {
        responses: 'Responses',
...
const enPatch: MessageTree = {
  ...
  admin: {
    ...
    platforms: {
      ...
      capabilitiesHint: 'Capabilities limit the API documentation endpoints available in the model plaza. Select only contracts actually supported by this upstream.',
      capability: {
        responses: 'Responses',
        chat_completions: 'Chat Completions',
        embeddings: 'Embeddings',
